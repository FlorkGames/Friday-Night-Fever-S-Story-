...
local ghost = 6;
function onBeatHit()
    objectPlayAnimation('ctas','bounce',true)

    if not lowQuality then
        if curBeat % 16 == 6 then
            if ghost == 6 then
                doTweenAlpha('boo', 'ghosts', 1, 0.01, 'circInOut')
                objectPlayAnimation('ghosts','scare1',true)
                doTweenAlpha('ghosttween', 'ghosts', 0.0, 1.2, 'circInOut')
                ghost = 1; 
            elseif ghost == 1 then
                doTweenAlpha('boo', 'ghosts', 1, 0.01, 'circInOut')
                objectPlayAnimation('ghosts','scare2',true)
                doTweenAlpha('ghosttween', 'ghosts', 0.0, 1.2, 'circInOut')
                ghost = 2;
            elseif ghost == 2 then
                doTweenAlpha('boo', 'ghosts', 1, 0.01, 'circInOut')
                objectPlayAnimation('ghosts','scare3',true)
                doTweenAlpha('ghosttween', 'ghosts', 0.0, 1.2, 'circInOut')
                ghost = 3;
            elseif ghost == 3 then
                doTweenAlpha('boo', 'ghosts', 1, 0.01, 'circInOut')
                objectPlayAnimation('ghosts','scare4',true)
                doTweenAlpha('ghosttween', 'ghosts', 0.0, 1.2, 'circInOut')
                ghost = 4;
            elseif ghost == 4 then
                doTweenAlpha('boo', 'ghosts', 1, 0.01, 'circInOut')
                objectPlayAnimation('ghosts','scare5',true)
                doTweenAlpha('ghosttween', 'ghosts', 0.0, 1.2, 'circInOut')
                ghost = 5;
            elseif ghost == 5 then
                doTweenAlpha('boo', 'ghosts', 1, 0.01, 'circInOut')
                objectPlayAnimation('ghosts','scare6',true)
                doTweenAlpha('ghosttween', 'ghosts', 0.0, 1.2, 'circInOut')
                ghost = 6;
            end
        end
...
function onEvent(n,v1,v2)
    if n == 'eventTrigger' then
        if v1 == 'cta1' then
            objectPlayAnimation('cta1','jump',true)
            doTweenAlpha('cta1show','cta1',1,0.01,'linear')
        end
        if v1 == 'cta2' then
            objectPlayAnimation('cta2','jump',true)
            doTweenAlpha('cta2show','cta2',1,0.01,'linear')
        end
        if v1 == 'cta3' then
            objectPlayAnimation('cta3','jump',true)
            doTweenAlpha('cta3show','cta3',1,0.01,'linear')
        end
        if v1 == 'cta4' then
            objectPlayAnimation('cta4','jump',true)
            doTweenAlpha('cta4show','cta4',1,0.01,'linear')
        end
        if v1 == 'cta5' then
            objectPlayAnimation('cta5','jump',true)
            doTweenAlpha('cta5show','cta5',1,0.01,'linear')
        end
        if v1 == 'ctasign' then
            objectPlayAnimation('ctasign','appear',true)
...
function onTimerCompleted(tag,loops,loopsLeft)
    if tag == 'signshow' then
        objectPlayAnimation('ctasign','sign',true)
